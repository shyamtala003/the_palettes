let colorPalettes = [{
    ...
    {
        paletteImage: "./uiux_images/7.webp",
        typefaceName: "nexa x inter",
        paletteColors: ['#eb5264', '#fdbc01', '#f7f7f7'],
        designer: 'websitebrainy',
        designerSocialLinks: [{
                socialSiteIcon: 'instagram',
                socialSiteUrl: "https://www.instagram.com/websitebrainy/"
            },
    ...
    {
        paletteImage: "./uiux_images/8.webp",
        typefaceName: "poppins",
        paletteColors: ['#2a314b', '#27b0fe', '#7d8295', '#ffffff'],
        designer: 'harshil acharya',
        designerSocialLinks: [{
                socialSiteIcon: 'instagram',
                socialSiteUrl: "https://www.instagram.com/harshil_designer/?hl=en"
    ...
    {
        paletteImage: "./uiux_images/9.webp",
        typefaceName: "SK Concretica",
        paletteColors: ['#ee4e24', '#fcbc05', '#34a853','#0c1d37','#fea27a','fef1ea'],
        designer: 'websitebrainy',
        designerSocialLinks: [{
                socialSiteIcon: 'instagram',
                socialSiteUrl: "https://www.instagram.com/websitebrainy/"
    ...
    {
        paletteImage: "./uiux_images/10.webp",
        typefaceName: "Samsung sharp sans",
        paletteColors: ['#fdf9e7', '#1081e8', '#c1c1c1'],
        designer: 'websitebrainy',
        designerSocialLinks: [{
                socialSiteIcon: 'instagram',
                socialSiteUrl: "https://www.instagram.com/websitebrainy/"
    ...
    {
        paletteImage: "./uiux_images/11.webp",
        typefaceName: "airbnb cereal app, urbanist",
        paletteColors: ['#3b50df', '#616679', '#201e42','#ff5771'],
        designer: 'websitebrainy',
        designerSocialLinks: [{
                socialSiteIcon: 'instagram',
                socialSiteUrl: "https://www.instagram.com/websitebrainy/"
    ...
    {
        paletteImage: "./uiux_images/12.webp",
        typefaceName: "gilroy",
        paletteColors: ['#040a20', '#4285f4', '#186efc','#161d34','#ffffff'],
        designer: 'taqwah_digital',
        designerSocialLinks: [{
                socialSiteIcon: 'instagram',
                socialSiteUrl: "https://www.instagram.com/taqwah_digital/"
            },
    ...
    {
        paletteImage: "./uiux_images/13.webp",
        typefaceName: "oxanium, work sans",
        paletteColors: ['#1c121f', '#ffce4e', '#372839','#ffffff'],
        designer: 'taqwah_digital',
        designerSocialLinks: [{
                socialSiteIcon: 'instagram',
                socialSiteUrl: "https://www.instagram.com/taqwah_digital/"
    ...
    {
        paletteImage: "./uiux_images/14.webp",
        typefaceName: "gilroy",
        paletteColors: ['#00e3a5', '#0d0d0d', '#80ab9e','#fafafa'],
        designer: 'taqwah_digital',
        designerSocialLinks: [{
                socialSiteIcon: 'instagram',
                socialSiteUrl: "https://www.instagram.com/taqwah_digital/"
    ...
    {
        paletteImage: "./uiux_images/15.webp",
        typefaceName: "exo, DM sans",
        paletteColors: ['#170d18', '#f827de', '#2b14f9','#2faf32','#ffffff'],
        designer: 'taqwah_digital',
        designerSocialLinks: [{
                socialSiteIcon: 'instagram',
                socialSiteUrl: "https://www.instagram.com/taqwah_digital/"
    ...
    {
        paletteImage: "./uiux_images/16.webp",
        typefaceName: "syncopate, gilroy",
        paletteColors: ['#040404', '#b9fd02', '#111518','#ccd2e3','#ffb801','#FF2F61'],
        designer: 'taqwah_digital',
        designerSocialLinks: [{
                socialSiteIcon: 'instagram',
                socialSiteUrl: "https://www.instagram.com/taqwah_digital/"
    ...
    {
        paletteImage: "./uiux_images/17.webp",
        typefaceName: "work sans",
        paletteColors: ['#006dff', '#fdc526', '#ff76fa','#ffffff'],
        designer: 'oyolloo',
        designerSocialLinks: [{
                socialSiteIcon: 'dribble',
                socialSiteUrl: "https://dribbble.com/Oyolloo"
            },
    ...
    {
        paletteImage: "./uiux_images/18.webp",
        typefaceName: "work sans",
        paletteColors: ['#ffd70c','#0f1014','#ffffff','#4e4d45'],
        designer: 'oyolloo',
        designerSocialLinks: [{
                socialSiteIcon: 'dribble',
                socialSiteUrl: "https://dribbble.com/Oyolloo"
    ...
    {
        paletteImage: "./uiux_images/19.webp",
        typefaceName: "nunito sans",
        paletteColors: ['#ffc335','#3affa5','#d1132d','#1c1c1c'],
        designer: 'oyolloo',
        designerSocialLinks: [{
                socialSiteIcon: 'dribble',
                socialSiteUrl: "https://dribbble.com/Oyolloo"
    ...
    {
        paletteImage: "./uiux_images/20.webp",
        typefaceName: "gotham",
        paletteColors: ['#2ec8d9','#74e4f0','#dfe4f5','#f7f9ff'],
        designer: 'Shafiqul Islam',
        designerSocialLinks: [{
                socialSiteIcon: 'instagram',
                socialSiteUrl: "https://www.instagram.com/kitket_design/"
            },
            {
                socialSiteIcon: 'dribble',
                socialSiteUrl: "https://dribbble.com/kitket1212"
            },
    ...
    {
        paletteImage: "./uiux_images/21.webp",
        typefaceName: "GT america",
        paletteColors: ['#e09d4a','#443e39','#c2c2c2','#ffffff','#fbfbf2'],
        designer: 'Shafiqul Islam',
        designerSocialLinks: [{
                socialSiteIcon: 'instagram',
                socialSiteUrl: "https://www.instagram.com/kitket_design/"
...
let addCard = (cardData) => {
    ...
    if (cardData.designerSocialLinks.length === 2) {
        ...
        <div class="social_links">
            <a href="${cardData.designerSocialLinks[0].socialSiteUrl}" aria-label="${cardData.designer}:instagram" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                    height="24">
            ...
            <a href="${cardData.designerSocialLinks[1].socialSiteUrl}" aria-label="${cardData.designer}:dribble" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                    height="24">
                    <path fill="none" d="M0 0h24v24H0z" />
                    <path class="svg_icon"
        ...
        if (cardData.designerSocialLinks[0].socialSiteIcon === "instagram") {
            authorInfo.innerHTML =
                `
        <span class="text">Designed by <span class="author">${cardData.designer}</span></span>
        <div class="social_links">
            <a href="${cardData.designerSocialLinks[0].socialSiteUrl}" aria-label="${cardData.designer}:instagram" target="_blank">
        ...
        `;
            ...
            <span class="text">Designed by <span class="author">${cardData.designer}</span></span>
            <div class="social_links">
                <a href="${cardData.designerSocialLinks[0].socialSiteUrl}" aria-label="${cardData.designer}:dribble" target="_blank">
                <svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                    height="24">
                    <path fill="none" d="M0 0h24v24H0z" />
                    <path class="svg_icon"
